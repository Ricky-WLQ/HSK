...
export const messages = {
  ...
  vocab: {
    ...
    play: "Play audio",
    audioError: "Audio is unavailable right now.",
    reveal: "Reveal",
    prev: "Prev",
    next: "Next",
  ...
  practice: {
    ...
    gradeFailed: "Couldn't grade your answer right now — please try again.",
    ...
    retry: "Try again",
    analyzing: "Analyzing…",
    analyzeError: "Couldn't load the explanation. Tap to retry.",
  ...
  exam: {
    ...
    finish: "Finish & grade",
    confirmSubmitSection: "Submit this section and move on? You can't come back to it.",
    confirmFinish: "Finish and grade your exam now? This can't be undone.",
  ...
  live: {
    ...
    connecting: "Connecting to the quiz…",
    waiting: "Waiting to start",
    waitingTeacher: "Waiting for your teacher to start…",
    loading: "Loading live quiz…",
    answerError: "Couldn't submit your answer — tap an option again.",
    participants: "joined",
    start: "Start quiz",
  ...
  schedule: {
    ...
    subtitle: "Schedule live sessions for this class; students book a seat.",
    newSession: "Schedule a session",
    sessionTitle: "Title (optional)",
    startAt: "Date & time",
    duration: "Duration (min)",
    capacity: "Seats",
    oneOnOne: "1 = one-on-one",
    recording: "Request recording",
    create: "Schedule",
    creating: "Scheduling…",
    none: "No upcoming sessions. Schedule one above.",
    noneStudent: "No upcoming live classes yet — your teachers' scheduled sessions will appear here.",
    booked: "booked",
    full: "Full",
    book: "Book seat",
    booking: "Booking…",
