...
export default function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <button
        className="w-11 h-11 flex items-center justify-center rounded-xl border-2 border-card-border bg-card"
  ...
  return (
    <button
      onClick={handleClick}
      className={`group/theme w-11 h-11 flex items-center justify-center rounded-xl border-2 bg-card active:scale-95 transition-all duration-200 cursor-pointer ${bgColors[theme]}`}
